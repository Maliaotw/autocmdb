    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('en', models.CharField(max_length=64, verbose_name='英文')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bus_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='host.businessunit', verbose_name='業務線')),
            ],
            options={
                'verbose_name': '服務器',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_key', models.FileField(blank=True, null=True, upload_to=host.models.content_file_name, verbose_name='私鑰')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('port', models.PositiveSmallIntegerField(default=22, verbose_name='端口')),
                ('user', models.CharField(default='cmdb', max_length=64, verbose_name='使用者')),
                ('passwd', models.CharField(default='b63^BU5dJRKz', max_length=64, verbose_name='密碼')),
                ('host', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='host.host', verbose_name='Host')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proc', models.ManyToManyField(to='host.Process')),
            ],
            options={
                'verbose_name': '服務器進程表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='host.host')),
                ('net', models.ManyToManyField(to='host.Net')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='host',
            name='node',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='host.node', verbose_name='分支'),
        ),
        migrations.CreateModel(
            name='Disk',
            fields=[
                ...
                ('host_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='disk', to='host.host')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cpu', to='host.host')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ManyToManyField(to='host.Host', verbose_name='主機')),
